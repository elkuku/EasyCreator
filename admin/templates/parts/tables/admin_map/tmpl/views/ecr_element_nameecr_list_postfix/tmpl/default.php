...
<div id="tablecell">
    ...
    {
    $row = &$this->items[$i];
    $link = JRoute::_('index.php?option=com_ECR_COM_NAME&controller=_ECR_LOWER_ELEMENT_NAME_&task=edit&cid[]='.$row->id);
	...
	<input type="hidden" name="view" value="_ECR_LOWER_ELEMENT_NAME_ECR_LIST_POSTFIX" />
