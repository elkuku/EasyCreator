 ...
 * @property-read  EcrGithubPackageRepositories $repositories   GitHub API object for the repositories package.
...
class EcrGithubHelper
{
	...
	{
		$class = 'EcrGithubPackage' . ucfirst($name);
