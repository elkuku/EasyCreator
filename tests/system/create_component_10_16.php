...
require_once '/home/elkuku/eclipse/workspace/pdt_2_2/easysvn_easycreator_16/tests/system/SeleniumJoomlaTestCase.php';

class CreateComponent extends SeleniumJoomlaTestCase
{
...
//  }
  ...
  public function testCreate_10_16()
  {
		$this->setUp();
		$this->gotoAdmin();
		$this->doAdminLogin();
      $this->open("administrator/index.php?option=com_easycreator");
    $this->waitForPageToLoad("30000");
    $this->select("ecr_project", "label=New project");
    $this->waitForPageToLoad("30000");
    $this->click("//a[@onclick=\"setTemplate('component', 'mvc_10_16'); goWizard(2);\"]");
    $this->waitForPageToLoad("30000");
