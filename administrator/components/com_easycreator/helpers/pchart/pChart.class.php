...
class pChart
{
    ...
    function loadColorPalette($FileName,$Delimiter=',')
    {
        ...
        if ($handle)
        {
            ...
            for($i = 0; $i < $ColorID; $i++)
            {
                $this->Palette[$ColorID + $i]['R'] = $this->Palette[$i]['R'];
                $this->Palette[$ColorID + $i]['G'] = $this->Palette[$i]['G'];
                $this->Palette[$ColorID + $i]['B'] = $this->Palette[$i]['B'];
            }//for
        }
    }
