 ...
 * @subpackage Models
 */
class ECR_COM_NAMEModelCategory extends JModelLegacy
{
    /**
     * Category id
     *
    ...
    public function __construct()
    {
        ...
        $this->setState('limitstart', $input->getInt('limitstart'));
        ...
        $this->setState('filter_order', $input->get('filter_order', 'id'));
        $this->setState('filter_order_dir', $input->get('filter_order_Dir', 'ASC'));

        $this->setId($input->getInt('id'));
    }
