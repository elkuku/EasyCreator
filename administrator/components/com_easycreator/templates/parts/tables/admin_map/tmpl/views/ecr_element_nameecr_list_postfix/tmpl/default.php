	...
	<tr>
		<td align="left" width="100%">
			...
			<button onclick="document.getElementById('search').value='';
				this.form.getElementById('filter_item').value='';this.form.submit();"><?php echo JText::_('Reset'); ?></button>
		</td>
		<td nowrap="nowrap">
...
<div id="tablecell">
    ...
    {
    $row = &$this->items[$i];
    $link = JRoute::_('index.php?option=com__ECR_COM_NAME_&controller=_ECR_LOWER_ELEMENT_NAME_&task=edit&cid[]='.$row->id);
	...
	<input type="hidden" name="view" value="_ECR_LOWER_ELEMENT_NAME__ECR_LIST_POSTFIX_" />
