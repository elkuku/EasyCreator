 ...
 *
 */
class _ECR_COM_NAME__ECR_LIST_POSTFIX_Model_ECR_ELEMENT_NAME__ECR_LIST_POSTFIX_ extends JModel
{
    var $_data;
    ...
    public function __construct()
    {
        ...
        $this->filter_order_Dir	= $application->getUserStateFromRequest($option.'.filter_order_Dir'
        , 'filter_order_Dir', '', 'word');
        //_ECR_MAT_ORDERING_MODAL1_
        $this->filter_order	= $application->getUserStateFromRequest($option.'.filter_order', 'filter_order'
        , 'ordering', 'cmd');
