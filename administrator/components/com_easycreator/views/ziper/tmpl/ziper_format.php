...
<?php EcrHtmlOptions::packing($this->project->buildOpts); ?>
<br/>
<br/>
...
<span class="img icon16-easycreator" style="font-weight: bold;">
...
<label class="inline" for="lbl_include_ecr_projectfile">
